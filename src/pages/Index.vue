<template>
  <Layout>
    <div
      class="hero container-inner mx-auto flex flex-col justify-center py-16"
    >
      ...
      >
        ...
        <div class="flex justify-center flex-col sm:flex-row items-center py-6">
          ...
          <div class="flex-1 text-lg sm:text-xl ml-6">
            ...
            and accessible web experiences. My consulting work is focused on
            front end development, design thinking, product prototyping, and
            technical strategy.
          </div>
        </div>
      </div>
    ...
    <div class="overflow-x-hidden bg-background-secondary">
      <div
        class="about container-inner mx-auto text-xl border-gray-500 py-16 mb-16 relative"
      >
        ...
        <ul class="text-lg sm:text-xl">
          <li class="checkmark mb-6">
            ...
            <div class="text-lg text-gray-600">
              From proof-of-concept prototypes to enterprise applications, I'm
              primarily using ES6/7/8 JavaScript with
              <a href="https://vuejs.org/" target="_blank">Vue</a> (along with
              its rich ecosystem of tooling) to build beautiful, performant,
              well-tested web experiences. That being said, I'm happy to work
              with <a href="https://reactjs.org/" target="_blank">React</a> or
              <a href="https://angular.io/" target="_blank">Angular</a> when
          ...
          <li class="checkmark mb-6">
            ...
            <div class="text-lg text-gray-600">
              ...
              <strong>
                in my experience,
                <i
                  >rapid, strategic iterations lead to better product
                  development</i
                > </strong
              >. My (continously improving)
              <a
                href="https://consultlowtide.ca/design-thinking-for-devs"
                target="_blank"
                >HCD/Design Thinking practice</a
              >
              is inspired by Dan Nessler's
              <a
                ...
                target="_blank"
                >Revised Double Diamond Framework</a
              >, the wealth of resources produced by
              <a
            ...
            <div class="text-lg text-gray-600">
              ...
              <strong
                >empathize, define, ideate, prototype, and test product
                iterations to produce measurable results.</strong
              >
              Feel free to
              <a href="#contact" title="Contact me!">reach out</a> if you'd like
          ...
          <li class="checkmark mb-6">
            ...
            <div class="text-lg text-gray-600">
              Let's empower your team to kick off a new project with the right
              foundation, or level up an existing code base (no matter how much
              TLC it needs). Easy-to-read, debuggable, modular code with strong
              unit/end-to-end testing coverage is the baseline.
            </div>
          </li>
          <li class="checkmark mb-6">
            <div>Collaborating with Incredible Clients</div>
            <div class="text-lg text-gray-600">
              Great product development is a partnership. I've been incredibly
              fortunate to work with some of Canada's most reputable companies,
              with teams ranging in size from two to over 200. I've helped to
              build new products for
              <a href="https://www.theglobeandmail.com/" target="_blank"
                >The Globe and Mail</a
              >
              (one of Canada's largest publishers), lectured for hundreds of
              students at
              <a href="https://www.lighthouselabs.ca/" target="_blank"
                >Lighthouse Labs</a
              >, levelled up development teams at established enterprise giants,
              and helped startups spin up their first prototypes. I take your
              trust seriously, and will always tell it as I see it.
            </div>
          </li>
        </ul>
      </div>
    ...
    <div class="contact-me overflow-x-hidden bg-background-tertiary pt-16">
      <div class="container-inner mx-auto text-xl pb-4 relative">
        ...
        <p class="mb-12">
          I'd love to discuss how we can knock your next project out of the
          park. You can reach me via the form below, on
          <a href="https://www.linkedin.com/in/martinlaws/">LinkedIn</a> or at
          <a href="mailto:martin@consultlowtide.ca">martin@consultlowtide.ca</a
          >. Messages regarding great food, craft beer, or stand-up comedy are
          welcomed.
        </p>
