<template>
  <Layout>
    <div class="hero container-inner mx-auto flex flex-col justify-center py-16">
      <div class="text-4xl font-bold text-center pb-8 md:pb-0">
        <div class="text-brand-primary leading-tight">I'm Martin,</div>
        <div class="leading-tight">Nice to meet you.</div>
      </div>
    </div>
    <!-- end hero -->
    ...
    <div class="overflow-x-hidden border-gray-200">
      <div class="get-to-know-me container-inner mx-auto text-xl pb-16 relative">
        <div class="absolute left-0" style="top: 100px; transform: translateX(-100%)">
          <svg width="170px" height="170px">
            <use xlink:href="#dots-triangle" />
          </svg>
        </div>

        <div class="flex justify-center flex-col sm:flex-row items-center py-6">
          <div class="w-full sm:w-1/2 px-8 py-8 sm:py-0">
            <g-image src="../../static/designer.svg" alt="browser" />
          </div>
          <div
            class="flex-1 text-lg sm:text-xl ml-6"
          >I'm a designer-developer crafting beautiful, functional, inclusive, and accessible web experiences. My consulting work is focused on front end development, design thinking, product prototyping, and technical strategy.</div>
        </div>
      </div>
      <!-- end get-to-know me -->
    </div>

    <div class="container-inner mx-auto"></div>
        ...
        <ul class="text-lg sm:text-xl">
          <li class="checkmark mb-6">
            ...
            <div class="text-lg text-gray-600">
              From proof-of-concept prototypes to enterprise applications, I'm primarily using ES6/7/8 JavaScript with
              <a
                href="https://vuejs.org/"
                target="_blank"
              >Vue</a> (along with its rich ecosystem of tooling) to build beautiful, performant, well-tested web experiences. That being said, I'm happy to work with
              <a
                href="https://reactjs.org/"
                target="_blank"
              >React</a> or
              <a href="https://angular.io/" target="_blank">Angular</a> when they're the right fit.
            </div>
          </li>
          <li class="checkmark mb-6">
            ...
            <div class="text-lg text-gray-600">
              ...
              <strong>
                in my experience,
                <i>rapid, strategic iterations lead to better product development</i>
              </strong>. My (continously improving)
              <a
                href="https://consultlowtide.ca/design-thinking-for-devs"
                target="_blank"
              >HCD/Design Thinking practice</a> is inspired by Dan Nessler's
              <a
                ...
                title="Dan Nessler's Revised Double Diamond Framework"
                target="_blank"
              >Revised Double Diamond Framework</a>, the wealth of resources produced by
              <a
                href="https://www.ideou.com/blogs/inspiration/what-is-design-thinking"
                title="IDEO - What is Design Thinking"
                target="_blank"
              >IDEO</a>, and
              <a
                href="https://dschool.stanford.edu/"
                title="Standford d.school"
                target="_blank"
              >The Stanford d.school</a>.
            </div>

            <hr />

            <div class="text-lg text-gray-600">
              In collaboration with stakeholders, we'll
              <strong>empathize, define, ideate, prototype, and test product iterations to produce measurable results.</strong> Feel free to
              <a href="#contact" title="Contact me!">reach out</a> if you'd like to discuss this further!
            </div>
          </li>
          <li class="checkmark mb-6">
            ...
            >Let's empower your team to kick off a new project with the right foundation, or level up an existing code base (no matter how much TLC it needs). Easy-to-read, debuggable, modular code with strong unit/end-to-end testing coverage is the baseline.</div>
          </li>
          <li class="checkmark mb-6">
            <div>Collaborating with Incredible Clients</div>
            <div class="text-lg text-gray-600">
              Great product development is a partnership. I've been incredibly fortunate to work with some of Canada's most reputable companies, with teams ranging in size from two to over 200. I've helped to build new products for
              <a
                href="https://www.theglobeandmail.com/"
                target="_blank"
              >The Globe and Mail</a> (one of Canada's largest publishers), lectured for hundreds of students at
              <a
                href="https://www.lighthouselabs.ca/"
                target="_blank"
              >Lighthouse Labs</a>, levelled up development teams at established enterprise giants, and helped startups spin up their first prototypes. I take your trust seriously, and will always tell it as I see it.
            </div>
          </li>
        </ul>
      </div>
    ...
    <div class="contact-me overflow-x-hidden bg-background-tertiary pt-16">
      <div class="container-inner mx-auto text-xl pb-4 relative">
        ...
        <p class="mb-12">
          I'd love to discuss how we can knock your next project out of the park. You can reach me via the form below, on
          <a
            href="https://www.linkedin.com/in/martinlaws/"
          >LinkedIn</a> or at
          <a href="mailto:martin@consultlowtide.ca">martin@consultlowtide.ca</a>. Messages regarding great food, craft beer, or stand-up comedy are welcomed.
        </p>
          ...
          <form name="contact" method="POST" class="mb-12" netlify>
            ...
            <div class="flex flex-wrap mb-6 -mx-4">
              <div class="w-full md:w-1/2 mb-6 md:mb-0 px-4">
                ...
                <input
                  ...
                  class="block w-full bg-background-form border border-border-color-primary shadow rounded outline-none focus:border-brand-primary mb-2 p-4"
                  required
                />
              </div>
              ...
              <div class="w-full px-4 md:w-1/2">
                ...
                <input
                  ...
                  name="email"
                  id="email"
                  placeholder="example@westeros.gov"
                  class="block w-full bg-background-form border border-border-color-primary shadow rounded outline-none focus:border-brand-primary mb-2 p-4"
                  required
                />
              </div>
            ...
            <div class="w-full mb-12">
              ...
              <textarea
                ...
                rows="5"
                name="message"
                class="block w-full bg-background-form border border-border-color-primary shadow rounded outline-none appearance-none focus:border-brand-primary mb-2 px-4 py-4"
            ...
            <div class="flex justify-end w-full">
              <input
                type="submit"
                value="Submit"
                class="block bg-brand-primary hover:bg-brand-secondary text-white text-sm font-semibold tracking-wide uppercase shadow rounded cursor-pointer px-6 py-3"
              />
            </div>
          </form>
        </div>
    ...
    <!-- end contact-me -->
    <div class="container-inner mx-auto -mt-48 overflow-x-hidden">
