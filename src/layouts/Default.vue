<template>
  <div
    id="home"
    class="home content-wrapper bg-background-primary font-sans text-copy-primary leading-normal flex flex-col min-h-screen"
    :class="theme"
  >
    ...
    <footer class="bg-brand-primary text-white">
      ...
      >
        ...
        <ul class="flex items-center">
          <li class="mr-8">
            <a
              href="mailto:martin@consultlowtide.ca"
              class="text-white hover:text-gray-400"
            >
              <svg
                width="25"
          ...
          <li>
            <a
              href="https://instagram.com/martinblaws"
              target="_blank"
              class="text-white hover:text-gray-400"
            >
              <svg
