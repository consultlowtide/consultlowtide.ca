<template>
  <div id="home" class="home content-wrapper bg-background-primary font-sans text-copy-primary leading-normal flex flex-col min-h-screen" :class="theme">
    <header class="border-t-14 border-brand-primary">
      <nav class="container mx-auto flex flex-wrap justify-between items-center py-8">
        <div>
          <g-link to="/">
            <div class="flex flex-col sm:flex-row justify-between">
              <div class="text-2xl font-bold w-full">
                <div class="leading-tight">Low Tide</div>
                <div class="leading-tight">Consulting</div>
              </div>
              
              <!-- <g-image src="../../static/icon--light.png" alt="logo" class="h-auto w-20" /> -->
            </div>
          </g-link>
        </div>
    ...
    <footer class="bg-brand-primary text-white">
      <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between py-8">
        ...
        <ul class="flex items-center">
          ...
          <li class="mr-8">
            <a href="https://github.com/martinlaws" target="_blank" class="text-white hover:text-gray-400">
          ...
          <li class="mr-8">
            <a href="https://twitter.com/martinblaws" target="_blank" class="text-white hover:text-gray-400">
          ...
          <li>
            <a href="https://instagram.com/martinblaws" target="_blank" class="text-white hover:text-gray-400">
